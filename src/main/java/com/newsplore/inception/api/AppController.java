...
public class AppController {
    ...
    @PostMapping(value = "/classify-and-locate")
    @CrossOrigin(origins = "*")
    public ClassifyImageService.LabelWithProbability classifyAndLocateImage(@RequestParam MultipartFile file) throws IOException {
        checkImageContents(file);
        return classifyImageService.classifyImage(file.getBytes());
    }
